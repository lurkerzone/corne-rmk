...
fn generate_vial_config() {
    ...
    // Vial keyboard id (8 bytes); distinct from stock RMK examples to avoid Vial collisions on one machine.
    let keyboard_id: Vec<u8> = vec![0xC0, 0x72, 0x6E, 0x65, 0x52, 0x4D, 0x4B, 0x01];
